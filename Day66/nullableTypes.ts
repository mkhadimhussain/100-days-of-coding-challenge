...
let userName: string | null = "Saif";  // The variable can hold the string or null

let age: number | null = null;         // The variable can hold the number or null
...
greetUser("Moiz");  // Output: Hello, Moiz
